...
<!--                            <img src="../images/staff6.jpg" alt="idea" class="ic-img-item">-->
                        ...
                        <div class="ic-review">
                            ...
                            <div class="ic-star">
                                <i class="fas fa-star ic-star-item"></i>
                                <i class="fas fa-star ic-star-item"></i>
                                <i class="fas fa-star ic-star-item"></i>
                                <i class="fas fa-star ic-star-item"></i>
                                <i class="fas fa-star ic-star-item"></i>
                        ...
                        <div class="ic-desc">
                            <div class ="ic-desc-heading">概要</div>
                            <div class ="ic-desc-overflow">
                                サンプルサンプル サンプルサンプル
                            </div>
...
<!--                            <img src="../images/staff6.jpg" alt="idea" class="ic-img-item">-->
                        ...
                        <div class="ic-desc">
                            <div class ="ic-desc-heading">概要</div>
                            <div class ="ic-desc-overflow">                        サンプルサンプル サンプルサンプル
                                サンプルサンプル サンプルサンプル
                            </div>
