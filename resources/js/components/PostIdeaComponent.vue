                ...
                <div class="profile-container-input">
                    ...
                    <div class="profile-container-img">
                        ...
                        <div class="profile-container-img-right">
                            <label>
                                <input id="img" @change="onFileChange" v-bind="img"
                                       class="c-input profile-container-img-none" type="file"/>
                    ...
                    <div class="profile-container-input">
                        ...
                        <input id="title" name="title" @blur="titleValidation()" v-model="title" class="c-input"
                               type="text" placeholder="（例）黄金の1hを生み出す方法">

                        <div class="error" v-if="errorMessages.titleErrorMessage">{{errorMessages.titleErrorMessage}}
                        </div>

                        <p><span :class="{'profile-container-validation':this.titleChangeColor}">{{titleLength}}</span>/24文字
                        </p>
                    </div>
                    ...
                    <div class="profile-container-input">
                        ...
                        <div class="c-radio-container">
                            ...
                            <input id="matching" v-model="category_id" @change="categoryValidation" name="category"
                                   type="radio" value=1>
                            <label for="matching" class="c-radio">マッチング</label>

                            <input id="board" v-model="category_id" @change="categoryValidation" name="category"
                                   class="" type="radio" value=2>
                            <label for="board" class="c-radio">掲示板</label>

                            <input id="sns" v-model="category_id" @change="categoryValidation" name="category" class=""
                                   type="radio" value=3>
                            <label for="sns" class="c-radio">SNS</label>

                            <input id="EC" v-model="category_id" @change="categoryValidation" name="category" class=""
                                   type="radio" value=4>
                            <label for="EC" class="c-radio">ECサイト</label>

                            <input id="infoplaner" v-model="category_id" @change="categoryValidation" name="category"
                                   class="" type="radio" value=5>
                            <label for="infoplaner" class="c-radio">情報発信</label>

                            <input id="sharing" v-model="category_id" @change="categoryValidation" name="category"
                                   class="" type="radio" value=6>
                            <label for="sharing" class="c-radio">シェアリング</label>

                            <input id="other" v-model="category_id" @change="categoryValidation" name="category"
                                   class="" type="radio" value=7>
                    ...
                    <div class="profile-container-input">
                        ...
                        <input id="price" v-model.number="price" type="number" @blur="priceValidation()" class="c-input"
                               placeholder="1000000円以内で設定して下さい">円

                        <div class="error" v-if="errorMessages.priceErrorMessage">{{errorMessages.priceErrorMessage}}
                        </div>
                    ...
                    <div class="profile-container-input">
                        ...
                        <textarea name="" v-model="overflow" @blur="overflowValidation()" id="profile"
                                  class="c-textarea" cols="30" rows="10" placeholder="自己紹介を記入してください"></textarea>
                        <div class="error" v-if="errorMessages.overflowErrorMessage">
                            {{errorMessages.overflowErrorMessage}}
                        </div>
                        <p><span
                            :class="{'profile-container-validation':this.overflowChangeColor}">{{overflowLength}}</span>/100文字
                        </p>
                    </div>
                    ...
                    <div class="profile-container-input">
                        ...
                        <textarea name="" v-model="content" @blur="contentValidation()" id="contents" class="c-textarea"
                                  cols="30" rows="10" placeholder="あなたのアイデアをお待ちしてます"></textarea>
                        <div class="error" v-if="errorMessages.contentErrorMessage">
                            {{errorMessages.contentErrorMessage}}
                        </div>
                        <p><span
                            :class="{'profile-container-validation':this.contentChangeColor}">{{contentLength}}</span>/10000文字
                        </p>
